  ...
  return (
    <>
      <button
        type="button"
        onClick={open}
        className="relative text-on-surface-variant hover:text-primary-container transition-colors h-full"
      ...
      >
        ...
        {totalItems > 0 && (
          <span className="absolute -top-2 -right-2 bg-coral-gold text-white text-[10px] font-bold h-4 w-4 rounded-full flex items-center justify-center">
